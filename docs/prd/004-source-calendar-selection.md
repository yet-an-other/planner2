...
- CONTEXT.md terms added or updated this session: **Source Calendar**, **Selected Source Calendars**, **Source Calendar Control**, **Source Calendar Picker**, and the **Calendar Event** definition (no longer hardcoded to the primary calendar).
