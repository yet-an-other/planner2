...
enum PlannerPalette {
    ...
    /// The connection dot's connected green.
    static let connectionDotConnected = Color(
        red: 0.318,
        green: 0.557,
        blue: 0.290
    )
    /// The connection dot's disconnected (and pulsing in-flight) gray.
    static let connectionDotDisconnected = Color(
        red: 0.580,
        green: 0.569,
        blue: 0.529
    )
